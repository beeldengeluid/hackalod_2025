...
const debug = Debug("lodster:generate:incorrect-birthyear")
...
export async function generateGuessIncorrectBirthYear(config: QuestionConfig): Promise<Question | undefined> {
